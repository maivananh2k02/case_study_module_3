        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="/author">hien thi cap quyen </a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="/manage-order">quan ly don hang</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('admin.addBrand')}}">Them Thuong hieu</a></li>
                        <li><a href="{{route('admin.showBrand')}}">Liet ke thuong hieu</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('admin.addProduct')}}">Them san pham</a></li>
                        <li><a href="{{route('admin.showProduct')}}">Liet ke san pham</a></li>
                    </ul>
                </li>
