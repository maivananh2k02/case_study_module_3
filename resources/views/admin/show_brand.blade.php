                ...
                <table class="table table-striped b-t b-light">
                    ...
                    @foreach($brand as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{'/brand_edit/'.$item->id}}" class="active" ui-toggle-class="">
                                    <i class="fa fa-pencil-square text-success text-active" style="font-size: 20px"></i>
                                </a>
                                <a href="{{'/brand_delete/'.$item->id}}" class="active" ui-toggle-class="" onclick="confirm('are you sure?')">
